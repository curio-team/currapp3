        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                @if($item->uitvoeren->count())
                    <p>Je gaat het cohort <strong>{{ $item->naam }}</strong> verwijderen. Dit cohort kent <strong>{{ $item->uitvoeren->count() }}</strong> blokken.</p>
                    ...
                    <p>Tenslotte verwijder je alle comments op modules, zolang het comment bij een uitvoer van dit cohort hoort.</p>
                @else
                    <p>Je gaat het cohort <strong>{{ $item->naam }}</strong> verwijderen.</p>
                    <p>Dit cohort kent <em>geen</em> uitvoeren, er  worden dus geen koppelingen verbroken.</p>
                @endif                
            </div>
